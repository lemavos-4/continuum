...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Title ref={ref} className={cn("font-display text-xl font-semibold tracking-tight text-[hsl(var(--popup-foreground))]", className)} {...props} />
));
...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Description ref={ref} className={cn("text-sm text-[hsl(var(--popup-muted))]", className)} {...props} />
));
