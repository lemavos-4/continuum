        ...
        <main className="min-w-0 flex-1">
          <header className="mb-8 hidden lg:block">
            <div className="min-w-0">
              ...
              <h1 className="mt-2 font-serif text-5xl tracking-tight text-foreground">{t("projects_title")}</h1>
            </div>
            <p className="mt-3 text-sm text-muted-foreground">{t("projects_subtitle")}</p>
          </header>
