    ...
    <AppLayout>
      <div className="flex h-[calc(100vh-3.5rem)] bg-background relative">
        ...
        <div className="flex-1 flex flex-col min-w-0 overflow-hidden relative">
          ...
          {/* Footer Metadata */}
          {note?.updatedAt && (
            <div className="fixed z-10 bottom-2 left-2 md:bottom-4 md:left-4 flex items-center gap-1.5 text-[10px] text-muted-foreground bg-background/80 backdrop-blur px-2 py-1 rounded-md border border-white/5">
        ...
        <aside className={`shrink-0 border-l border-white/5 bg-background/30 backdrop-blur-md transition-all duration-300 ease-in-out overflow-hidden flex flex-col z-40
