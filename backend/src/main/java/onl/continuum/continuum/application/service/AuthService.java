...
import onl.continuum.continuum.domain.token.TokenBlacklist;
...
public class AuthService {
    ...
    @Transactional
    public AuthResponse googleAuth(onl.continuum.continuum.infra.google.GoogleOAuthService.GoogleUserInfo googleUser) {
